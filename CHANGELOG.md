...
* Added: Option to continously set the SOC_CALCULATION based on cell voltages @efoilbuilder-F
* Added: Daly_HKMS_100balance BMS with modbus communication @efoilbuilder-F
